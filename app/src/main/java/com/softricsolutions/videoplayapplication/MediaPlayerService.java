...
public class MediaPlayerService extends Service {
    ...
    public static final String BROADCAST_TO_SERVICE = "com.softricsolutions.playerfunction";
    public static final String SERVICE_TO_ACTIVITY = "com.softricsolutions.currentPlayerStatus";
